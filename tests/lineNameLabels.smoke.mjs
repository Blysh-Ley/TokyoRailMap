...
assert.equal(labelLayer.layer.layout['symbol-spacing'], 100000);
assert.equal(labelLayer.layer.layout['symbol-avoid-edges'], true);
...
assert.equal(labelLayer.layer.layout['text-max-angle'], 20);
