...
assert.match(appCssSource, /flex: 0 0 70px;/);
assert.match(appCssSource, /width: 5ch;/);
assert.match(appCssSource, /gap: 0;/);
assert.match(appCssSource, /max-width: min\(280px, calc\(100vw - 40px\)\);/);
