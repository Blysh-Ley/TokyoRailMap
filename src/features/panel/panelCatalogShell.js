...
// panelShellDesktop.js
const DEFAULT_HIDDEN_TRANSFORM_panelShellDesktop = 'translateX(calc(100% + 24px))';
...
export const createDesktopPanelShell = ({
    ...
    root.style.transform = DEFAULT_HIDDEN_TRANSFORM_panelShellDesktop;
