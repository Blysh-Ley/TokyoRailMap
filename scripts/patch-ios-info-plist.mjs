...
const PHOTO_USAGE_VALUES = {
    NSPhotoLibraryUsageDescription: 'TokyoRailMap needs photo library access to save exported rail maps and timetable images.',
    NSPhotoLibraryAddUsageDescription: 'TokyoRailMap needs permission to save exported rail maps and timetable images to Photos.'
};
