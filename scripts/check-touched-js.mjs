...
const printHelp = () => {
    console.log([
        'Usage:',
        '  node scripts/check-touched-js.mjs',
        '  node scripts/check-touched-js.mjs --staged',
        '  node scripts/check-touched-js.mjs --base=HEAD~1',
        '  node scripts/check-touched-js.mjs src/app.js tests/example.mjs',
        '',
